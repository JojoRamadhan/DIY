void setup() {
  ...
  int baudRate = 115200; // Baud rate untuk komunikasi dengan ESP32

#ifdef MIDI_DIN
  baudRate = 31250; // Untuk MIDI DIN
#endif
  ...
  Serial1.begin(baudRate); // Inisialisasi Serial1 untuk komunikasi dengan ESP32
  delay(100);
